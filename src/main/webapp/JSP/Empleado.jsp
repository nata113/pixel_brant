                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="txtSala" name="txtSala" placeholder="Salario" aria-label="Direccion" aria-describedby="basic-addon1" onkeypress="return soloNumero(event)" required>
                                </div>
