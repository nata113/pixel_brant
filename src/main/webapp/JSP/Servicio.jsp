                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea class="form-control" rows="4" id="txtDescripcion" name="txtDescripcion" placeholder="Descripción" aria-label="Regalias" aria-describedby="basic-addon1" required></textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" rows="4" id="txtDescripcione" name="txtDescripcione" placeholder="Descripción" aria-label="Regalias" aria-describedby="basic-addon1" required></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
