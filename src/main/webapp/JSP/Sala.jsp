<html lang="en">
    ...
    <body >
        ...
        <section class="collapse" id="collapseCreate" style="padding-bottom:40px">
            <div class="container">
                <form onsubmit="return Validar()" name="form1" action="ServletSala" method="post" name="ReservarSala">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="custom-select" id="txtEncargado" name="txtEncargado">
                                        ...
                                        <%
                                            ...
                                            String strQuery1t = "select num_ide, concat(NOMBRES,' ',APELLIDO_1) from emple";
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <div class="pull-right">
                                        <input type="submit" class="btn btn-primary" style="color:#ffffff; display: none" value="EDITAR" name="opc1" id="EDITAR">
                                        <input type="submit" class="btn btn-primary" style="color:#ffffff" value="RESERVAR" name="opc1" id="RESERVAR">
        ...
        <section class="collapse" id="collapseCreate2" style="padding-bottom:40px">
            <div class="container">
                <form onsubmit="return Validar()" name="form1" action="ServletSala" method="post" name="CrearSala">
                    <div class="card card-body">
                        <div class="row">
                            <div class="col-lg-3">
                            </div>
